...
add_argument('--learning_rate', 0.1, type=float)
...
add_argument('--batch_size', 10, type=int)
add_argument('--vis_size', 200, type=int)
add_argument('--mode', 'train')
add_argument('--spacing', 3, type=int)
add_argument('--start_eps', 0.5, type=float)
add_argument('--end_eps', 0.01, type=float)
add_argument('--start_temp', 100, type=float)
add_argument('--end_temp', 1, type=float)
add_argument('--annealing_episodes', 5000, type=float)
